...
export const useDiscountManagement = (params?: {
  ...
  return {
    discounts: discountsQuery.data?.data?.data || discountsQuery.data?.data || discountsQuery.data || [],
    pagination: {
      current_page: discountsQuery.data?.data?.current_page || discountsQuery.data?.current_page || 1,
      total: discountsQuery.data?.data?.total || discountsQuery.data?.total || 0,
      per_page: discountsQuery.data?.data?.per_page || discountsQuery.data?.per_page || 15,
    },
